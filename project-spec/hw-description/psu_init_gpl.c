...
/*##################################################################### */
    ...
    * This register controls this reference clock
    * (OFFSET, MASK, VALUE)      (0XFF5E00A8, 0x01003F07U ,0x01000300U)
    */
...
/*##################################################################### */
    ...
    * This register controls this reference clock
    * (OFFSET, MASK, VALUE)      (0XFF5E00B8, 0x01003F07U ,0x01000300U)
    */
...
/*##################################################################### */
    ...
    * 6 bit divider
    *  PSU_CRL_APB_PL1_REF_CTRL_DIVISOR0                           0x2e
    ...
    * This register controls this reference clock
    * (OFFSET, MASK, VALUE)      (0XFF5E00C4, 0x013F3F07U ,0x01012E02U)
    */
	PSU_Mask_Write(CRL_APB_PL1_REF_CTRL_OFFSET,
		0x013F3F07U, 0x01012E02U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180148, 0x03FFFFFFU ,0x03000F80U)
    */
	PSU_Mask_Write(IOU_SLCR_BANK0_CTRL5_OFFSET,
		0x03FFFFFFU, 0x03000F80U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180144, 0x03000F80U ,0x03000F80U)
    */
	PSU_Mask_Write(IOU_SLCR_BANK0_CTRL4_OFFSET,
		0x03000F80U, 0x03000F80U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180164, 0x03FFFFFFU ,0x0000003FU)
    */
	PSU_Mask_Write(IOU_SLCR_BANK1_CTRL5_OFFSET,
		0x03FFFFFFU, 0x0000003FU);
/*##################################################################### */
