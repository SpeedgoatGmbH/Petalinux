...
set psu_clock_init_data {
    ...
    mask_write 0XFF5E00A8 0x01003F07 0x01000300
    ...
    mask_write 0XFF5E00B8 0x01003F07 0x01000300
    ...
    mask_write 0XFF5E00C4 0x013F3F07 0x01012E02
		# Register : AMS_REF_CTRL @ 0XFF5E0108</p>
...
set psu_mio_init_data {
    ...
    mask_write 0XFF180148 0x03FFFFFF 0x03000F80
    ...
    mask_write 0XFF180144 0x03000F80 0x03000F80
    ...
    mask_write 0XFF180164 0x03FFFFFF 0x0000003F
